...
sr.reveal(`.home__img, .footer__container, .footer__group`, {delay:700, origin:'bottom'})
...
const sendEmail = (e) =>{
     ...
     if(contactUser.value === ''){
        ...
        emailjs.sendForm('service_icdsqoe' , 'template_beo8rwa' , '#contact-form' , 'kveTG8dAOAWwbYtjj')
             .then(() =>{
